function [ListOfExtremalAssemblagesOut] = zero_recursion_rank(ListOfExtremalAssemblages,Assemblage,Probability,CompletedInputs,ZeroTol)
...
Assemblage=assemblage_clean(Assemblage,ZeroTol);
...
%Before we begin our iteration, we will clean the assemblage: this means,
%get rid of small/negative eigenvalues, and re-symmetrise.
...
if NumberofPerturbations==0
    ...
    [Sucess,OutputCell] = apply_perturbation_rank(Probability,Assemblage,FullOperatorList...
    ...
    error('Failed Perturbation')
       ...
       %If we suceeded, we need to keep going with our perturbations! 
        ...
        ListOfExtremalAssemblagesOut = zero_recursion_rank(ListOfExtremalAssemblages,NewAssemblage1,NewProb1,CompletedInputs,ZeroTol);
        ListOfExtremalAssemblages=ListOfExtremalAssemblagesOut;
        ListOfExtremalAssemblagesOut = zero_recursion_rank(ListOfExtremalAssemblages,NewAssemblage2,NewProb2,CompletedInputs,ZeroTol);
        ListOfExtremalAssemblages=ListOfExtremalAssemblagesOut;                                
...
if NumberofPerturbations==0
    ...
    ListOfExtremalAssemblagesOut=zero_recursion_rank(ListOfExtremalAssemblages,Assemblage,Probability,CompletedInputs-1,ZeroTol);
    ListOfExtremalAssemblages=ListOfExtremalAssemblagesOut;
else
    ...
    [Sucess,OutputCell] = apply_perturbation_rank(Probability,Assemblage,OperatorList...
